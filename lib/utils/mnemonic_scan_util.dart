...
import 'package:hotconut_wallet/widgets/body/address_qr_scanner_body.dart';
import 'package:hotconut_wallet/widgets/overlays/common_bottom_sheets.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:mobile_scanner/mobile_scanner.dart';

String normalizeMnemonicText(String raw) => raw.trim().replaceAll(RegExp(r'\s+'), ' ');

Future<String?> showMnemonicQrScannerBottomSheet(BuildContext context, {required String title}) async {
  MobileScannerController? qrViewController;
  bool isQrDataHandling = false;
  final qrKey = GlobalKey(debugLabel: 'MnemonicQR');
  ...
  void onDetect(BarcodeCapture capture) {
    ...
    Navigator.pop(context, normalizeMnemonicText(rawValue));
  }
